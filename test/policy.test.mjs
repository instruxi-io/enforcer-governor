...
// Reroute ("finish somewhere cheaper") lived on the proxy path, and v2 ships
// no proxy -- it is a Claude Code plugin. The handoff tests left with it; the
// feature and its tests are on the v1 branches if the proxy comes back.
